...
import {
  ...
  DEFAULT_HOOKS,
  DEFAULT_SAVE,
  DEFAULT_SAVE_FILTER_KEYS,
  DEFAULT_SAVE_FILTER_KEYS_STRATEGY,
  DEFAULT_SAVE_ON_CHANGE,
  DEFAULT_SAVE_ON_EXIT,
  DEFAULT_SYNC,
  DEFAULT_SYNC_FILTER_KEYS,
  DEFAULT_SYNC_FILTER_KEYS_STRATEGY,
  type Fn,
  merge,
  type State,
  type StoreHooks,
...
class Store<S extends State> extends BaseStore<S> {
  ...
  constructor(id: string, proxy: S, options: TauriPluginValtioStoreOptions<S> = {}) {
    ...
    this.options = {
      ...
      saveFilterKeys: options.saveFilterKeys ?? DEFAULT_SAVE_FILTER_KEYS,
      saveFilterKeysStrategy: options.saveFilterKeysStrategy ?? DEFAULT_SAVE_FILTER_KEYS_STRATEGY,
      ...
      syncFilterKeys: options.syncFilterKeys ?? DEFAULT_SYNC_FILTER_KEYS,
      syncFilterKeysStrategy: options.syncFilterKeysStrategy ?? DEFAULT_SYNC_FILTER_KEYS_STRATEGY,
